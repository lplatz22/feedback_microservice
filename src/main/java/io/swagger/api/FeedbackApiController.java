...
public class FeedbackApiController implements FeedbackApi {
    ...
    public ResponseEntity<List<Feedback>> getFeedback() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Feedback>>(objectMapper.readValue("[ {  \"feedback\" : \"feedback\",  \"rev\" : \"rev\",  \"created_ts\" : \"created_ts\",  \"name\" : \"name\",  \"rating\" : 0,  \"id\" : \"id\"}, {  \"feedback\" : \"feedback\",  \"rev\" : \"rev\",  \"created_ts\" : \"created_ts\",  \"name\" : \"name\",  \"rating\" : 0,  \"id\" : \"id\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
